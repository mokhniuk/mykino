...
- **Personalized home feed** with 6 auto-refreshing sections: *Because You Liked*, *By Genre*, *Now Playing*, *Trending*, *Popular*, and *Hidden Gems*
...
- **Transparent analytics** — only anonymous page-view counts via [Umami](https://umami.mokhni.uk/websites/36b2fed3-e325-4e17-b7e1-1fdcfdd3ef1c) (public dashboard)
